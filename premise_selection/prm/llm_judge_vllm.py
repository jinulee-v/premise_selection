...
class VLLMPRM:
    def __init__(self, device=None, model="Qwen/Qwen3-4B-Instruct-2507", **kwargs):
    ...
    def get_combination_scores(self, step_combinations):
        ...
        async def score_combination(comb, request_id):
        ...
        async def runner():
            tasks = [score_combination(comb, i) for i, comb in enumerate(step_combinations)]
...
class Qwen25_7bPRM(VLLMPRM):
    def __init__(self, device=None, **kwargs):
        super().__init__(device=device, model="Qwen/Qwen2.5-7B-Instruct", **kwargs)
